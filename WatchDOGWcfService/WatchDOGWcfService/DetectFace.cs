...
namespace WatchDogWcf
{
    class DetectFace
    {
        public static FacesWithEyes Detect(Image<Bgr, Byte> image, string faceFileName, String eyeFileName, out long detectionTime, double faceRatio, double eyeRatio)
        {
